...
function addLayer(type, overrides) {
    ...
    const layer = {
        ...
        width: o.width !== undefined ? o.width : (type === 'text' ? 200 : type === 'trigger' ? 42 : type === 'component' ? 360 : 120),
        height: o.height !== undefined ? o.height : (type === 'text' ? 40 : type === 'trigger' ? 42 : type === 'component' ? 48 : 80),
        visible: true,
        ...
        // Styling
        content: type === 'text' ? 'Double-click' : '',
        ...
        backgroundColor: type === 'rect' ? '#737373' : type === 'circle' ? '#737373' : 'transparent',
        borderRadius: type === 'circle' ? 50 : type === 'trigger' ? 12 : 0,
        borderStyle: type === 'trigger' ? 'none' : '',
        borderThickness: 0,
        borderColor: type === 'trigger' ? '#64748b' : '',
